...
func main() {
	...
	go setupControllers(mgr, cCache, queues, certsReady, ctx, &cfg, serverVersionFetcher)
...
func setupControllers(mgr ctrl.Manager, cCache *cache.Cache, queues *queue.Manager, certsReady chan struct{}, ctx context.Context, cfg *configapi.Configuration, serverVersionFetcher *kubeversion.ServerVersionFetcher) {
